...
Also, before moving on to explain the code below, I want to let you know that I am aware the code is not the best and can be improved significantly. I created this library in a total time of 1 to 1.5 hours. So, yeah 😅
...
```js
{
  ...
  "description": "Compress Image and Video using node",
  "bin": {
