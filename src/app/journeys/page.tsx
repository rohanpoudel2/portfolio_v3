          ...
          <ul className='space-y-5'>
            <li className='bg-gray-50 dark:bg-zinc-800/50 px-4 rounded-xl'>
              <div className='flex items-center justify-start gap-2'>
                ...
                <span className='font-mono text-sm text-zinc-600 dark:text-zinc-400'>Destinations I have explored on my motorbike.</span>
              </div>
            </li>
            <li className='bg-gray-50 dark:bg-zinc-800/50 px-4 rounded-xl'>
              <div className='flex items-center justify-start gap-3'>
                ...
                />
                <span className='font-mono'>:</span>
                <span className='font-mono text-sm text-zinc-600 dark:text-zinc-400'>Destinations I have explored by car.</span>
              </div>
            </li>
            <li className='bg-gray-50 dark:bg-zinc-800/50 px-4 rounded-xl'>
              <div className='flex items-center justify-start gap-3'>
                ...
                />
                <span className='font-mono'>:</span>
                <span className='font-mono text-sm text-zinc-600 dark:text-zinc-400'>Destinations I have trekked.</span>
              </div>
            </li>
          </ul>
        </>
